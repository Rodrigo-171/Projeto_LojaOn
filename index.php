...
<body class="no-js">
  ...
  <div class="container">
    <section class="section_conheco">
      ...
      <p>Eu sei que você tem dificuldade em saber qual é o próximo passo, saber
        planejar a próxima ação de venda, saber qual produto focar na próxima semana e
        mesmo quando finalmente consegue se planejar não consegue executar, e por
        isso, no final do dia sempre se sente <!--<span id="pontos">...</span><span id="mais">-->improdutiva.
          Sei disso, porque também tenho uma loja online desde 2013 e olhando pra trás
          vejo que só foi possível sair do zero e faturar mais de 2 milhões por ano quando
          comecei a criar planos de ações semanais. É esse planejamento que compartilho
          com você dentro do LojaON!<!--</span>-->
      </p>
    ...
    <section id="comofunc" class="section_como_func container">
      ...
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/WsEv01p3GXU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
  ...
  <section class="section_descubra">
    <div class="container">
      ...
      <div class="embed-responsive embed-responsive-16by9">
        <iframe id="video" class="embed-responsive-item" frameborder="0" src="media/HTML 5 - Videos e IFrames em HTML (Video 09).mp4" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
      <div class="div_p_video">
        <p class="p_subtitulo_video">Clique nas aulas abaixo e confira mais trechos, que foram selecionados com cuidado para te ajudar a chegar mais longe.
          A sua mudança começa agora.</p>
      </div>

      <div class="galeria_video">
        <div onclick="trocar1()" class="card_video" id="video-1-desk" data-src="media/HTML 5 - Videos e IFrames em HTML (Video 09).mp4">
        ...
        <div onclick="trocar2()" class="card_video" id="video-2-desk" data-src="media/HTML 5 - Videos e IFrames em HTML (Video 09).mp4">
        ...
        <div onclick="trocar3()" class="card_video" id="video-3-desk" data-src="media/HTML 5 - Videos e IFrames em HTML (Video 09).mp4">
